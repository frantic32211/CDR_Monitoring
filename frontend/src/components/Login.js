...
const Login = () => {
    ...
    return (
        <div className='w-screen h-screen flex-col justify-center '>
            ...
            <div className='w-5/12 h-2/3 bg-slate-100 text-center mx-auto pt-4 rounded-md'>

                <div className=" bg-slate-600 mx-4 rounded-md">
                    ...
                    <form onSubmit={true}>
                        ...
                        <div className="w-3/4 bg-white text-center">
                            <button type="submit" name="login" value="Login" className="">
                                Sign In
                            </button>
                        </div>
                    </form>
